...
public class RemoveConcernImage_Home {
...
ChromeDriver driver = new ChromeDriver();
     ...
     // Click on the App builder section
      ...
      /*  wait.until(ExpectedConditions.elementToBeClickable(
				By.xpath("//*[@id=\"root\"]/div[2]/div/main/div/div/div[3]/div/div/div/div[4]/div[2]/div[1]/div/div/button[2]")
		)).click();     */
        
        WebElement removeBtn = wait.until(ExpectedConditions.presenceOfElementLocated(
        	    By.xpath("//button[.//svg[contains(@class,'lucide-trash-2')]]")
        	));
