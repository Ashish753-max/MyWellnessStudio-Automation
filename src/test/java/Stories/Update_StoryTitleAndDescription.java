...
ChromeDriver driver = new ChromeDriver();
		...
		WebElement field = driver.findElement(By.xpath("//input[@placeholder='e.g., Client Success Journey']"));
		...
		WebElement field1 = driver.findElement(By.xpath("//textarea[@placeholder='Tell the story of the transformation...']"));
