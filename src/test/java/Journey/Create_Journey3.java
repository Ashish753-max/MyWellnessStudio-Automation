...
ChromeDriver driver = new ChromeDriver();
		...
		String imagePath = "C:\\Users\\user\\Downloads\\7zwg66zlovwiny9pe4fxae3dd1dq (1).jpg";
		uploadImage.sendKeys(imagePath);
		
		// Enter the Journey title
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@placeholder='e.g., Weekly Acne Recovery Routine']"))).sendKeys("BBL - Redness");
		
		// enter the description
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//textarea[@placeholder='A brief explanation of this journey...']"))).sendKeys("Targets redness and visible facial vessels using laser technology");
