...
ChromeDriver driver = new ChromeDriver();
        ...
        // click on the delete button of the journey 
		wait.until(ExpectedConditions.elementToBeClickable(
				By.xpath("//*[@id=\"root\"]/div[2]/div/main/div/div/div[2]/div[1]/table/tbody/tr[1]/td[6]/div/div/div[2]/button"))).click();
		
		 // click on the confirm delete button
		wait.until(ExpectedConditions.elementToBeClickable(
				By.xpath("//*[@id=\"root\"]/div[2]/div/main/div/div[2]/div[2]/div[2]/div/button[2]"))).click();
